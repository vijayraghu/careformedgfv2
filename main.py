...
def welcome():
	...
	if (end <= timestamp >= start):
		...
		data = {"service" : wireline}
		json_data = json.dumps(data)
		query_parameter = dialogflow.types.QueryParameters(payload=json_data)
